...
https://img.shields.io/badge/JavaFX-21-blue.svg
https://img.shields.io/badge/build-passing-brightgreen.svg
https://img.shields.io/badge/coverage-85%2525-green.svg
...
Basic Gameplay
First Move: Black places a piece on any empty octagonal cell

Turn Alternation: Players alternate turns, placing either:

A piece on an octagonal cell, or

A bridge on a diamond cell

Cell Ownership: Once claimed, cells belong to the claiming player permanently
...
text
<img width="500" height="720" alt="image" src="https://github.com/user-attachments/assets/17150952-2e77-4f46-8d69-0c46a03cc8e2" />
Core Components
1. Board Model
...
Configure JavaFX runtime in Preferences
...
Issue Assignment: Claim an issue or create a new one

Development: Implement with tests
